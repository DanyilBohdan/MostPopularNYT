...
public class EmailedFragment extends Fragment {
    ...
    private RecyclerView emailedArticle;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        if(InternetConnection.checkConnection(v.getContext())){
            ...
            Call<Example> call = api.getEmailedJSON();
            ...
            call.enqueue(new Callback<Example>() {
                ...
                public void onResponse(Call<Example> call, Response<Example> response) {
                    ...
                    emailedArticle = v.findViewById(R.id.rv_articles);

                    LinearLayoutManager layoutManager = new LinearLayoutManager(v.getContext());
                    emailedArticle.setLayoutManager(layoutManager);

                    articlesAdapter = new ArticlesAdapter(v.getContext(), articlesList);
                    emailedArticle.setAdapter(articlesAdapter);
                }
